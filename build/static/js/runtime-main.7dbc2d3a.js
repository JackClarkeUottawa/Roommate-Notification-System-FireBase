!(function (e) {
  function t(t) {
    for (
      var n, i, a = t[0], f = t[1], l = t[2], p = 0, s = [];
      p < a.length;
      p++
    )
      (i = a[p]),
  ...
  (i.m = e),
    ...
    (i.p = "/");
  var a = (this.webpackJsonproommatenotificationsystem =
      this.webpackJsonproommatenotificationsystem || []),
    f = a.push.bind(a);
  (a.push = t), (a = a.slice());
...
//# sourceMappingURL=runtime-main.7dbc2d3a.js.map
